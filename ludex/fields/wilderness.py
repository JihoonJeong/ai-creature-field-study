...
class Wilderness:
            ...
            if creature.memory:
                ...
                try:
                    creature.memory.handle_remember(
                        ...
                        tags=["wilderness", self.name, f"tick_{tick}"],
    ...
    def _parse_action(self, response: str) -> str:
        ...
        Looks for 'action: X' or '**X**' patterns first, then falls back
        to keyword search. Order matters — check specific patterns before
        broad keyword matching to avoid 'rested' matching 'rest'.
        """
        response_lower = response.lower()

        # Pattern 1: "action: rest" or "action: explore"
        import re
        ...
        # Pattern 2: "I choose **explore**" or "I'll explore"
            ...
            try:
                ...
                for c in self.creatures:
                    if c.engine:
                        ...
                        reflect(c.organism, trigger="wilderness_complete", engine=c.engine)
